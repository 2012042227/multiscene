...
SESprite text2;
    ...
    col1 = add_sprite_for_color(Color.instance("black"), 0.25*get_scene_width(), 0.25*get_scene_height());
        ...
        col3 = add_sprite_for_color(Color.instance("green"), 0.25*get_scene_width(), 0.25*get_scene_height());
        col3.move(0.75*get_scene_width(),0.8*get_scene_height());

        col4 = add_sprite_for_color(Color.instance("yellow"), 0.25*get_scene_width(), 0.25*get_scene_height());
